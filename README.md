# rawjs
Raw Javascript Framework in < 50 lines 1.3kb library. Build the web the native way. Its almost ReactJS-like! ReactJS uses {} RawJS uses the native ${} for templating without any bundling or additional library with same functionality. 
## Image
